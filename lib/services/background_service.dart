...
class BackgroundService {
  ...
  Future<void> initialize() async {
    ...
    try {
      // Initialize WorkManager with the callback dispatcher from the separate file
  ...
  /// Update user activity (call this when user opens the app)
    ...
    try {
      ...
      if (lastActiveDate != null) {
        ...
        if (daysSinceLastActive == 1) {
          ...
          Logger.info('Streak updated: ${currentStreak + 1}');
        } else if (daysSinceLastActive == 0) {
          // Same day, no streak change needed
          Logger.info('User active today, streak maintained: $currentStreak');
        }
      }
    } catch (e) {
